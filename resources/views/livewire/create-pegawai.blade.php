	          ...
	          <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
	            ...
	            <div class="grid grid-cols-9 gap-6">
	              <div class="col-span-6 sm:col-span-4 grid gap-6">
	              	<div>
		                ...
		                <input type="text" name="first-name" autocomplete="given-name" class="mt-1 border py-2 px-3 border-gray-300 focus:border-blue-500 focus:ring-blue-500 block w-full shadow-sm text-sm font-medium rounded-xl outline-none">
	              	</div>
	              	<div>
	              ...
	              <div class="col-span-6 sm:col-span-4">
	                ...
	                <textarea type="text" name="first-name" id="first-name" autocomplete="given-name" class="mt-1 border py-2 px-3 border-gray-300 focus:border-blue-500 focus:ring-blue-500 block w-full h-5/6 shadow-sm text-sm font-medium rounded-xl outline-none" style="resize: none;"></textarea>
	              </div>
	            </div>
	            ...
	            <div class="grid grid-cols-9 gap-6">
	              ...
	              <div class="col-span-6 sm:col-span-4">
	                ...
	                <input type="text" name="first-name" id="first-name" autocomplete="given-name" class="mt-1 border py-2 px-3 border-gray-300 focus:border-blue-500 focus:ring-blue-500 block w-full shadow-sm text-sm font-medium rounded-xl outline-none">
	              </div>
	            </div>
            	...
            	<div class="grid grid-cols-9 gap-6">
	              <div class="col-span-6 sm:col-span-4 grid gap-6">
	                ...
	                <div>
		                ...
		                <textarea type="text" name="first-name" autocomplete="given-name" class="mt-1 border py-2 px-3 border-gray-300 focus:border-blue-500 focus:ring-blue-500 block w-full h-5/6 shadow-sm text-sm font-medium rounded-xl outline-none" style="resize: none;"></textarea>
	                </div>
	              </div>
	              <div class="col-span-6 sm:col-span-1">
	              </div>
	              <div class="col-span-6 sm:col-span-4">
	              	<div class="grid gap-6">
		              	...
		              	<div class="w-full flex">
			                <a style="cursor: pointer;" href="#" class="button mt-1 text-blue-800 mx-auto hover:text-indigo-400 focus:text-gray-500">
