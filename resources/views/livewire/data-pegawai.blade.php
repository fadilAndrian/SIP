                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            <div class="flex item-center justify-center">
                              <!-- show -->
                                <a href="/data-pegawai/{{$x->id}}" style="cursor: pointer;" class="w-4 mx-1.5 transform hover:text-purple-500 hover:scale-110">
                                ...
                                <!-- delete -->
                                <div wire:click="delete({{$x->id}})" onclick="confirm('Yakin untuk menghapus?') || event.stopImmediatePropagation()" style="cursor: pointer;" class="w-4 mx-1.5 transform hover:text-purple-500 hover:scale-110">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
